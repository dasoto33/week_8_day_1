...
let implicitlyTypedArray = ["Na na na", "na na na", "hey hey", "Goodbye"]
...
let stringBoolsArray: [string, ...boolean[]] = ["astring"]
...
console.log(nameUpper("dylan smith"))
...
enum Size3 {Small = 5, Medium = "M", Large = "L"}
...
console.log(Size3 = Size3.Medium);
...
let mySize5: Size3 = Size3.ExtraLarge
...
let student2 = {id:1, name:"Alfonzo"}
...
let iceMan: {
    ...
    name: string,
    wasFrozen: boolean
} = {id: 3, name: "Wim Hof", wasFrozen: true}
...
let iceMan1 = {id:33, name:"Patrick", wasFrozen:true}
let iceMan2 = {id:37, name:"Spongebob", wasFrozen:false}
let iceMan3 = {id:69, name:"Rudolf", wasFrozen:true}
...
function ice14(param: boolean|string):boolean {
    if (typeof param == "boolean"){
        return param
    } else {
...
console.log(ice14(true))
console.log(ice14("California"))
console.log(ice14("New Mexico"))
